...
<?php endif; ?>
  ...
  <style><?php echo file_get_contents(__DIR__ . '/../public/barely.css') ?>main{margin-bottom:4em}article img{display:block;width:100%;max-width:800px; margin:auto}</style>
</head>
<body>
